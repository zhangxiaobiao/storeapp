...
return array (
  ...
  'STORE_ADMINABOUTUS_DEFAULT' => '关于我们',
  'STORE_ADMINABOUTUS_EDIT' => '编辑关于我们',
  'STORE_ADMINABOUTUS_INDEX' => '关于我们',
  'STORE_ADMINDELIVERY_ADD' => '添加发货',
  'STORE_ADMINDELIVERY_ADDPOST' => '添加发货提交',
  'STORE_ADMINDELIVERY_DELETE' => '发货删除',
  'STORE_ADMINDELIVERY_EDIT' => '编辑发货',
  'STORE_ADMINDELIVERY_INDEX' => '发货管理',
  'STORE_ADMINDELIVERY_SEND' => '发货',
  'STORE_ADMININVOICE_ADD' => '添加发票',
  'STORE_ADMININVOICE_ADDPOST' => '添加发票提交',
  'STORE_ADMININVOICE_DELETE' => '发票删除',
  'STORE_ADMININVOICE_EDIT' => '编辑发票',
  'STORE_ADMININVOICE_INDEX' => '发票管理',
  'STORE_ADMINOPINION_DEFAULT' => '意见反馈',
  'STORE_ADMINOPINION_DELETE' => '删除反馈',
  'STORE_ADMINOPINION_INDEX' => '反馈管理',
  'STORE_ADMINOPINION_ISREAD' => '标记已读',
  'STORE_ADMINORDER_ADD' => '添加订单',
  'STORE_ADMINORDER_DELETE' => '删除订单',
  'STORE_ADMINORDER_DETAIL' => '查看订单',
  'STORE_ADMINORDER_EDIT' => '修改订单',
  'STORE_ADMINORDER_INDEX' => '发货订单',
  'STORE_ADMINPRODUCT_ADD' => '添加产品',
  'STORE_ADMINPRODUCT_ADDPOST' => '添加产品提交',
  'STORE_ADMINPRODUCT_DEFAULT' => '产品中心',
  'STORE_ADMINPRODUCT_DELETE' => '客服中心删除',
  'STORE_ADMINPRODUCT_EDIT' => '编辑产品',
  'STORE_ADMINPRODUCT_INDEX' => '产品中心',
  'STORE_ADMINPRODUCT_LISTORDER' => '产品排序',
  'STORE_ADMINPRODUCT_PUBLISH' => '产品上架',
  'STORE_ADMINPRODUCT_RECOMMEND' => '产品推荐',
  'STORE_ADMINPRODUCTATTRIBUTE_ADD' => '添加属性',
  'STORE_ADMINPRODUCTATTRIBUTE_DELETE' => '删除属性',
  'STORE_ADMINPRODUCTATTRIBUTE_EDIT' => '修改属性',
  'STORE_ADMINPRODUCTATTRIBUTE_INDEX' => '商品属性',
  'STORE_ADMINPRODUCTATTRIBUTE_LISTORDER' => '属性排序',
  'STORE_ADMINPRODUCTCATEGORY_ADD' => '添加分类',
  'STORE_ADMINPRODUCTCATEGORY_DELETE' => '删除分类',
  'STORE_ADMINPRODUCTCATEGORY_EDIT' => '修改分类',
  'STORE_ADMINPRODUCTCATEGORY_INDEX' => '商品分类',
  'STORE_ADMINPRODUCTORDER_ADD' => '添加订单',
  'STORE_ADMINPRODUCTORDER_DEFAULT' => '订单管理',
  'STORE_ADMINPRODUCTORDER_DELETE' => '删除订单',
  'STORE_ADMINPRODUCTORDER_DETAIL' => '查看订单',
  'STORE_ADMINPRODUCTORDER_EDIT' => '修改订单',
  'STORE_ADMINPRODUCTORDER_INDEX' => '产品订单',
  'STORE_ADMINPRODUCTTYPE_ADD' => '添加模型',
  'STORE_ADMINPRODUCTTYPE_DELETE' => '删除模型',
  'STORE_ADMINPRODUCTTYPE_EDIT' => '修改模型',
  'STORE_ADMINPRODUCTTYPE_INDEX' => '模型管理',
  'STORE_ADMINRECRUIT_DEFAULT' => '司机招募',
  'STORE_ADMINRECRUIT_DELETE' => '删除招募',
  'STORE_ADMINRECRUIT_INDEX' => '招募管理',
  'STORE_ADMINRECRUIT_ISREAD' => '标记已读',
  'STORE_ADMINSERVICE_ADD' => '添加客服中心',
  'STORE_ADMINSERVICE_ADDPOST' => '添加客服中心提交',
  'STORE_ADMINSERVICE_DEFAULT' => '客服中心',
  'STORE_ADMINSERVICE_DELETE' => '客服中心删除',
  'STORE_ADMINSERVICE_EDIT' => '编辑客服中心',
  'STORE_ADMINSERVICE_INDEX' => '客服中心',
  'STORE_ADMINSERVICE_LISTORDER' => '客服中心排序',
  'STORE_ADMINSHIPPING_ADD' => '添加快递',
  'STORE_ADMINSHIPPING_ADDPOST' => '添加快递提交',
  'STORE_ADMINSHIPPING_DEFAULT' => '商城配置',
  'STORE_ADMINSHIPPING_DELETE' => '快递删除',
  'STORE_ADMINSHIPPING_EDIT' => '编辑快递',
  'STORE_ADMINSHIPPING_INDEX' => '快递管理',
  'STORE_ADMINSHIPPINGCONTROLLER_DEFAULT' => '--new--',
  'STORE_ADMINSPEC_ADD' => '添加规格',
  'STORE_ADMINSPEC_DELETE' => '删除规格',
  'STORE_ADMINSPEC_EDIT' => '修改规格',
  'STORE_ADMINSPEC_INDEX' => '规格管理',
  'STORE_ADMINTRUCK_ADD' => '添加货车',
  'STORE_ADMINTRUCK_DEFAULT' => '发货管理',
  'STORE_ADMINTRUCK_DELETE' => '删除货车',
  'STORE_ADMINTRUCK_EDIT' => '修改货车',
  'STORE_ADMINTRUCK_INDEX' => '货车管理',
  'STORE_ADMINTRUCK_LISTORDER' => '货车排序',
